...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      CI: (x0,x1) => new WebSocket(x0,x1),
      CJ: (a, s, e) => a.splice(s, e),
      CK: x0 => x0.z,
      ...
      EH: (x0,x1) => { x0.type = x1 },
      EI: x0 => x0.code,
      EJ: (x0,x1,x2,x3,x4) => x0.call(x1,x2,x3,x4),
      EK: x0 => x0.x,
      F: () => new Error().stack,
      ...
      FI: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      FJ: () => globalThis.kwPushFrame,
      FK: x0 => x0.close(),
      ...
      GI: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      ...
      QI: (x0,x1,x2) => x0.insertBefore(x1,x2),
      ...
      SI: x0 => x0.offsetHeight,
      SJ: (x0,x1) => x0.getModifierState(x1),
      SK: (x0,x1) => x0.createMediaElementSource(x1),
      T: x0 => new Promise(x0),
      ...
      TG: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      ...
      UF: x0 => x0.innerWidth,
      UG: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      ...
      UI: x0 => x0.stopPropagation(),
      UJ: x0 => x0.altKey,
      UK: x0 => x0.createStereoPanner(),
      V: (constructor, args) => {
      ...
      VE: x0 => x0.parent,
      VF: x0 => x0.height,
      VG: (x0,x1,x2,x3) => x0.pushState(x1,x2,x3),
      VH: (x0,x1) => x0.dispatchEvent(x1),
      VI: x0 => x0.disabled,
      VJ: x0 => x0.ctrlKey,
      VK: (x0,x1) => x0.connect(x1),
      W: x0 => new Array(x0),
      ...
      aE: x0 => x0.y,
      aF: (x0,x1) => { x0.name = x1 },
      aG: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      ...
      fI: x0 => new WeakRef(x0),
      fJ: (x0,x1) => x0.key(x1),
      fK: (x0,x1) => { x0.preload = x1 },
      ...
      hF: x0 => ({runApp: x0}),
      hG: x0 => x0.parentElement,
      hH: x0 => x0.arrayBuffer(),
      hI: () => globalThis.WeakRef,
      hJ: (x0,x1) => x0.removeItem(x1),
      ...
      iG: (x0,x1) => x0.querySelectorAll(x1),
      iH: o => {
        if (o === null || o === undefined) return 0;
      ...
      nI: (x0,x1) => x0.get(x1),
      nJ: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      nK: x0 => x0.body,
      ...
      tH: (x0,x1) => x0.getRandomValues(x1),
      tI: x0 => x0.status,
      tJ: x0 => x0.name,
      u: () => [],
      ...
      vH: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      vI: x0 => x0.read(),
      vJ: x0 => new Accelerometer(x0),
