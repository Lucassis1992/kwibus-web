...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      KI: (o, t) => typeof o === t,
      KJ: (x0,x1,x2,x3,x4) => x0.call(x1,x2,x3,x4),
      KK: x0 => x0.x,
      L: o => o === undefined,
      ...
      YK: (x0,x1) => x0.createMediaElementSource(x1),
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      tI: x0 => x0.url,
      tJ: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      tK: x0 => x0.body,
      u: () => [],
