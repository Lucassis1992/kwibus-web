...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      EF: x0 => x0.tiltY,
      EG: x0 => x0.value,
      EH: x0 => x0.multiViewEnabled,
      EI: (x0,x1) => new WebSocket(x0,x1),
      EJ: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      ...
      GH: (x0,x1) => { x0.type = x1 },
      GI: x0 => x0.code,
      GJ: (a, s, e) => a.splice(s, e),
      GK: (x0,x1) => { x0.onreading = x1 },
      ...
      JJ: (x0,x1,x2,x3,x4) => x0.call(x1,x2,x3,x4),
      JK: x0 => x0.x,
      K: (exn) => {
      ...
      QI: (map, o, v) => map.set(o, v),
      QJ: x0 => x0.width,
      QK: (x0,x1) => { x0.value = x1 },
      ...
      VG: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      ...
      WF: x0 => x0.innerWidth,
      WG: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      ...
      XF: x0 => x0.height,
      XG: (x0,x1,x2,x3) => x0.pushState(x1,x2,x3),
      XH: (x0,x1) => x0.dispatchEvent(x1),
      XI: x0 => x0.disabled,
      XJ: (x0,x1) => x0.getModifierState(x1),
      XK: (x0,x1) => x0.createMediaElementSource(x1),
      Y: (o0, o1) => [o0, o1],
      YB: (t, s) => t.set(s),
      ...
      cE: (s) => +s,
      cF: (x0,x1) => { x0.name = x1 },
      cG: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      cH: (x0,x1) => x0.writeText(x1),
      cI: (x0,x1) => { x0.spellcheck = x1 },
      cJ: x0 => x0.code,
      cK: x0 => x0.destination,
      d: (o, p) => o[p],
      dB: o => {
        if (o === null || o === undefined) return 0;
      ...
      hI: x0 => new WeakRef(x0),
      hJ: () => globalThis.window,
      hK: (x0,x1) => { x0.playbackRate = x1 },
      i: (l, r) => l === r,
      ...
      jF: x0 => ({runApp: x0}),
      jG: x0 => x0.parentElement,
      jH: x0 => x0.arrayBuffer(),
      jI: () => globalThis.WeakRef,
      ...
      kG: (x0,x1) => x0.querySelectorAll(x1),
      kH: o => {
        if (o === null || o === undefined) return 0;
      ...
      sI: x0 => x0.name,
      sJ: (x0,x1,x2) => ({files: x0,title: x1,text: x2}),
      sK: x0 => x0.body,
      t: (o, p, v) => o[p] = v,
      tB: o => {
        if (o === null || o === undefined) return 0;
      ...
      tI: x0 => x0.statusText,
      tJ: (x0,x1) => ({files: x0,text: x1}),
      tK: (x0,x1) => new OffscreenCanvas(x0,x1),
      u: () => [],
      ...
      vH: (x0,x1) => x0.getRandomValues(x1),
      vI: x0 => x0.status,
      vJ: x0 => ({files: x0}),
      vK: x0 => x0.loader,
      ...
      wH: () => globalThis.crypto,
      wI: x0 => x0.getReader(),
      wJ: (x0,x1) => ({title: x0,text: x1}),
      wK: () => globalThis._flutter,
